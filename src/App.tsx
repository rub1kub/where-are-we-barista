...
function AutopilotOutputPanel({ result, output }: { result: TerrainMatchResult; output: AutopilotOutput }) {
  return (
  ...
  return (
    <section className="methodology">
      ...
      <article>
        ...
        <span>Карта высот взята из сэмпла Copernicus GLO-30, спутниковая подложка нужна только для ориентира, NMEA можно заменить внешним журналом.</span>
      </article>
      <article>
        ...
        <aside className="right-rail">
          {result && currentPoint ? (
            <>
              ...
              />
              {currentAutopilotOutput ? <AutopilotOutputPanel result={result} output={currentAutopilotOutput} /> : null}
